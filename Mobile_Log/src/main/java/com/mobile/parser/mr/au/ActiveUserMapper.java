...
public class ActiveUserMapper extends Mapper<LongWritable, Text, StatusUserDimension, TimeOutputWritable> {
    ...
    private KpiDimension activeKpi = new KpiDimension(KpiTypeEnum.ACTIVE_USER.kipName);
    private KpiDimension activeBrowserKpi = new KpiDimension(KpiTypeEnum.ACTIVE_USER_BROWSER.kipName);
