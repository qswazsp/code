...
public class LocationRunner implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapOutputKeyClass(StatusLocationDimension.class);
        job.setMapOutputValueClass(MyMaperOutput.class);

        job.setReducerClass(LocationReducer.class);
        job.setOutputKeyClass(StatusLocationDimension.class);
        job.setOutputValueClass(MyReduceOutput.class);
