...
public class ActiveNumberMapper extends Mapper<LongWritable, Text, StatusUserDimension, TimeOutputWritable> {
    ...
    private KpiDimension activeKpi = new KpiDimension(KpiTypeEnum.ACTIVE_NUMBER.kipName);
    private KpiDimension activeBrowserKpi = new KpiDimension(KpiTypeEnum.ACTIVE_NUMBER_BROWSER.kipName);
